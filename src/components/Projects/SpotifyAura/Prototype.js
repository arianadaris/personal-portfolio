...
import MediumFidelity from '../../../assets/SpotifyAura_MFW_Desktop.png';
import HomeMediumFidelity from '../../../assets/SpotifyAura_MFW_Home.png';
import HighFidelity from '../../../assets/SpotifyAura_HFW.png';
            ...
            <div className={styles.prototypeContainer}>
                ...
                <div className={styles.medium}>
                    <Zoom overlayBgColorStart="rgba(0, 0, 0, 0.25)" overlayBgColorEnd="rgba(0, 0, 0, 0.15)">
                        <img id={styles.mobile} src={MediumFidelity} alt="Medium Fidelity Wireframe" style={{marginRight: "1rem"}} />
                    </Zoom>
                    <Zoom overlayBgColorStart="rgba(0, 0, 0, 0.25)" overlayBgColorEnd="rgba(0, 0, 0, 0.15)">
                        <img id={styles.mobile} src={HomeMediumFidelity} alt="Mobile Medium Fidelity Wireframe" />
                    </Zoom>
                </div>
                <div className={`${styles.high} ${'slide'}`}>
                    ...
                    <div>
                        <Zoom overlayBgColorStart="rgba(0, 0, 0, 0.25)" overlayBgColorEnd="rgba(0, 0, 0, 0.15)">
                            <img id={styles.high} src={HighFidelity} alt="High Fidelity Wireframe" />
                        </Zoom>
                    </div>
                    <a id={styles.prototypeBtn} href="https://www.figma.com/file/dWbSGqR2y1PGWbWC7CZUiK/Personal-Website?node-id=0%3A1" target="_blank" rel="noreferrer">View Final Prototype</a>
                </div>
