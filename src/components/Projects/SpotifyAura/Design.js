...
import LowFidelity from '../../../assets/PersonalPortfolio_LFW.png';
    ...
    return (
        <div className={`${styles.desktopContainer} ${'slide'}`} style={{'--mainColor': mainColor}}>
            <div className={styles.designContainer}>
                ...
                <p>After doing research on the concept, I created lo-fi wireframes to start mapping out design decisions.</p>
